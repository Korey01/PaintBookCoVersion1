...
export default function Footer() {
  return (
    <footer
      style={{ backgroundColor: "#1B3A5C", fontFamily: "Arial, system-ui, sans-serif" }}
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="text-xl font-bold text-white inline-block mb-4">
              PaintBookCo
            </Link>
          ...
          {/* Company links */}
          <div>
            <p className="text-white/40 text-xs uppercase tracking-wider mb-5">Company</p>
          ...
          {/* Legal links */}
          <div>
            <p className="text-white/40 text-xs uppercase tracking-wider mb-5">Legal</p>
            <ul className="space-y-3">
