              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Get accurate quotes in minutes with our AI-powered estimator
                    tool.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Connect with verified, insured painters in your area
                    instantly.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-8 md:space-y-12 text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                We'll handle vetting, pricing alignment, escrow protection, and
                project coordination — so you stay in control without the admin.
              </p>
            </motion.div>
            ...
            >
              <div className="space-y-4 p-6 rounded-2xl border border-border/50 bg-card/50 backdrop-blur hover:bg-card hover:border-border transition-all duration-300">
                ...
                <p className="text-sm text-muted-foreground">
                  Track progress and trigger payments at each project milestone
              ...
              <div className="space-y-4 p-6 rounded-2xl border border-border/50 bg-card/50 backdrop-blur hover:bg-card hover:border-border transition-all duration-300">
                ...
                <p className="text-sm text-muted-foreground">
                  Protect both your business and your painters with secure,
                  regulated escrow settlement.
                </p>
              </div>
              ...
              <div className="space-y-4 p-6 rounded-2xl border border-border/50 bg-card/50 backdrop-blur hover:bg-card hover:border-border transition-all duration-300">
                ...
                <p className="text-sm text-muted-foreground">
                  Manage multiple projects across multiple locations with one
                  point of contact.
                </p>
              </div>
            </motion.div>
        ...
        <div className="mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto px-1 sm:grid sm:grid-cols-2 sm:gap-6 sm:overflow-visible sm:px-0 lg:grid-cols-3">
          {[...painters]
            ...
            .map((p) => (
              <div
                key={p.id}
                className="min-w-[80%] snap-center sm:min-w-0 scroll-animate"
              >
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Enter room dimensions, number of coats and openings. Get litres
                required and a baseline material cost. Attach to your job post
                with one click.
              </p>
            </div>
            <div className="flex gap-4 flex-wrap">
              <Button onClick={() => navigate("/vestimator")} size="lg">
                Open Vestimator
              </Button>
              <Button
      ...
      >
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[
            {
              quote:
                "Flawless finish and super professional. The escrow deposit made payment stress-free.",
              name: "Ella R.",
              location: "London",
            },
            {
              quote:
                "Booked in a day, loved the portfolio, and the estimate tool was spot on.",
              name: "James K.",
              location: "Leeds",
            },
            {
              quote:
                "Felt safe with ID verified and insured badges. Great experience.",
              name: "Priya S.",
              location: "Bristol",
            },
          ].map((t, i) => (
