      ...
      <section className="relative overflow-hidden">
        <div className="container mx-auto px-4 pt-0 pb-0 md:pt-0">
          <div className="relative flex flex-col items-center text-center w-full h-[60vh]">
            <LogoStroke />
            <motion.div className="pointer-events-auto absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 flex flex-wrap items-center justify-center gap-3 px-4" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }}>
