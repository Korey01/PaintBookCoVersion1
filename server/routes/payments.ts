 ...
 */
router.post("/initiate", authMiddleware, requireCustomer, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.get("/escrow/:transactionId", authMiddleware, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.post("/webhook/transpact", async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.post("/release/:jobId", authMiddleware, async (req: Request, res: Response): Promise<void> => {
  try {
...
function formatEscrowTransactionResponse(transaction: any): EscrowTransactionResponse {
  return {
    id: transaction.id,
